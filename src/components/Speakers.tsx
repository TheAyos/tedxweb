...
import { Card, Flex, HStack, Container, VStack, Text, Box, Image, Link, Span } from "@chakra-ui/react";
...
const Speakers = () => {
    return (
        <>
            ...
            {/*to use when there is still no information about speakers*/}
        ...
        >
            ...
            {SPEAKERS.map((edition, i) => (
                <Flex key={i} justify="space-around" flexWrap="wrap" py={10} gap={10} boxSizing={"border-box"}>
                    <Box width="full">
                        ...
                        >
                            <Box position="relative" zIndex={1}>
                                ...
                                <Card.Body gap={3}>
                                    ...
                                    <Card.Description textAlign={"justify"}>{s.title}</Card.Description>
                                    <Card.Title fontWeight="medium">{s.speech_title}</Card.Title>
                                    <Card.Description whiteSpace="pre-line" textAlign={"justify"}>{s.speech_description}</Card.Description>
