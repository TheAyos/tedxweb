...
const About: React.FC = () => {
    return (
        <>
            <Container as="main" pt={12} bg="black" color="white" maxW="container.xl" textAlign={"justify"}>
                <VStack gap={12} align="stretch">
                    <Text as={"h2"} id="theteam" fontSize={"3xl"} fontWeight={"medium"} textAlign={"center"}>
                        Who are we?
                    </Text>
                    <Flex flexDir={{ base: "column", md: "row" }} align="center">
                        <Image src="images/2024/full-members.jpg" width={{ base: "100%", sm: "xl" }} height={"auto"} />

                        <Text as={"p"} fontSize={"md"} fontWeight={"medium"} mt={{ base: 10, md: 0 }} px={{ base: 0, md: 8 }}>
                    ...
                    <VStack align="stretch" gap={4}>
                        ...
                        <Text fontSize="xs">
                            ...
                            people together to share a TED-like experience. Our event is called TEDxÉcolePolytechnique, where x = independently organized TED event. At our
                        ...
                        {/* Social Media Links */}
                        <HStack fontSize="xs" wrap={"wrap"} justifyContent={"space-around"} gap={2} align="center">
